...
import com.example.kotlinnchappapp.databinding.ItemContainerRecevedMessageBinding
import com.example.kotlinnchappapp.databinding.ItemContanerSendMessageBinding
...
class ChatAdapter(
    ...
    internal class ReceivedMessageViewHolder(private val binding: ItemContainerRecevedMessageBinding) :
        RecyclerView.ViewHolder(
            binding.root
        ) {
